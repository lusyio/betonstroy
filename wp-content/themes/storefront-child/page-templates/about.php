    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-12 mt-auto">
                <a class="btn btn-outline-white mb-0" href="#">Продукция</a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-4">
                <div class="card-certificate">
                    <div class="card-certificate__header">
                        <img src="/wp-content/themes/storefront-child/images/img-certificate-example.jpg" alt="">
                    </div>
                    <div class="card-certificate__body">
                        <p class="card-certificate__title">Свидетельство о соответствии качества бетона</p>
                        <a href="#">Показать ></a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6 col-12">
                <div class="card-passport">
                    ...
                    <div>
                        <p class="card-passport__title">Портландцемент ЦЕМ | 42,5Н ГОСТ 31108-2016</p>
                        <a href="#">Показать ></a>
                    </div>
                </div>
            </div>
